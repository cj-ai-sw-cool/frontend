...
export const NAV = [
  ...
  {
    // 슬롯 창고 3D — 실측 물동량 61일치로 창고 점유를 보여 준다.
    // ⚠️ 대시보드(P3 담당)에 끼워 넣지 않고 **별도 화면**으로 뒀다. 남의 화면 구조를
    //    바꾸는 대신 여기에 항목을 하나 늘리는 편이 경계를 안 넘는다.
    href: "/warehouse-win98",
    label: "w98 창고",
    owner: "P1",
    description: "슬롯 창고 3D — 실측 물동량 61일 (2024-08-01 ~ 10-31)",
  },
  {
