 ...
 *   transform: scale() 로 뷰포트 폭에 맞춰 통째로 줄인다. 줄어들 뿐 잘리지 않으므로
 *   화면 어느 구석의 경고도 항상 보인다. 잘림 위험이 사라진 이상, 스크롤을 허용해
 *   레이아웃이 기기마다 달라지게 두는 것보다 "모든 단말에서 픽셀 단위로 같은 화면"이
 *   훨씬 낫다 — 현장 교육과 문제 재현이 쉬워지고, 화면 캡처가 디자인과 1:1 로 맞는다.
